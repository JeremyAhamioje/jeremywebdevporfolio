...
export const ALL_PROJECTS: ProjectPanel[] = [
  { num: '01', super: 'E-Commerce / Farm Supplier', title: 'SINOTH FARMS',
    ...
    year: '2026', role: 'Design & Dev', href: 'https://sinothfarms.store/', panelBg: 'linear-gradient(135deg,#06120a,#0a2410)', flip: true },
  { num: '02', super: 'E-Commerce / Full-Stack', title: 'SHREDDED',
  ...
  { num: '03', super: 'AI Productivity Tool', title: 'JEREMY AI',
  ...
  { num: '04', super: 'Luxury Brand / Design', title: 'MAISON JEREMY',
  ...
  { num: '05', super: 'EdTech / 3D / Immersive', title: 'NIGHTSHIFT\nOBSERVATORY',
  ...
  { num: '06', super: 'CMS / Blog Platform', title: 'JEREMY BLOG',
  ...
  { num: '07', super: 'OS-Inspired / Experimental', title: 'WINDOWS\nPORTFOLIO',
  ...
  { num: '08', super: 'Space / Advancement', title: 'ORBITA',
  ...
  { num: '09', super: 'Engineering Portfolio', title: 'JEREMY\nENGINEERING',
  ...
  { num: '10', super: 'Motion / Luxury Automotive', title: 'PAGANI\nEXPERIENCE',
  ...
  { num: '11', super: 'Gaming / Interactive', title: 'GAMING HUB',
  ...
  { num: '12', super: 'AI / Travel Planning', title: 'TRIPPIT',
  ...
  { num: '13', super: 'Music / Retro Web App', title: 'RETRO SPINS',
  ...
  { num: '14', super: 'Museum / 3D Interactive', title: 'GLOBAL\nMUSEUM HUB',
  ...
  { num: '15', super: 'UI/UX Design / Figma', title: 'FOOD\nDELIVERY APP',

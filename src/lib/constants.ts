...
export const HOME_PROJECTS: ProjectCard[] = [
  ...
  {
    num: '04/', title: 'Parking Arbitrage', subtitle: 'Parking',
...
export const ALL_PROJECTS: ProjectPanel[] = [
  ...
  { num: '08', super: 'Price Intelligence / Full-Stack', title: 'PARKING\nARBITRAGE',
    desc: 'Real-time parking price intelligence across SpotHero, ParkWhiz and Way.com. Scrapers write to Supabase; an Express API serves a Next.js dashboard that surfaces live prices and arbitrage signals.',
    tags: ['Next.js', 'Supabase', 'Playwright'],
    video: 'https://res.cloudinary.com/dz6kxumoo/video/upload/f_auto,q_auto/v1782160141/Screen_Recording_2026-06-22_212206_e1cnt6.mp4',
    image: 'https://images.unsplash.com/photo-1506521781263-d8422e82f27a?w=900&q=80',
    year: '2026', role: 'Full-Stack Dev', href: 'https://parking-arbitrage-ui.vercel.app/', panelBg: 'linear-gradient(135deg,#050a0f,#0a1420)', flip: true },
  { num: '09', super: 'E-Commerce / Farm Supplier', title: 'SINOTH FARMS',
    desc: 'Storefront for a Nigerian farm supplier — live and processed chicken, eggs, turkeys and peppers, catalogued for restaurants, distributors and bulk buyers with WhatsApp ordering.',
    tags: ['Web Design', 'Cloudinary', 'WhatsApp'],
    video: 'https://res.cloudinary.com/dz6kxumoo/video/upload/f_auto,q_auto/v1782992619/Screen_Recording_2026-07-02_123505_p1nwlt.mp4',
    image: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=900&q=80',
    year: '2026', role: 'Design & Dev', href: 'https://sinothfarms.store/', panelBg: 'linear-gradient(135deg,#06120a,#0a2410)' },
  { num: '10', super: 'Engineering Portfolio', title: 'JEREMY\nENGINEERING',
  ...
  { num: '11', super: 'Motion / Luxury Automotive', title: 'PAGANI\nEXPERIENCE',
  ...
  { num: '12', super: 'Gaming / Interactive', title: 'GAMING HUB',
  ...
  { num: '13', super: 'AI / Travel Planning', title: 'TRIPPIT',
  ...
  { num: '14', super: 'Music / Retro Web App', title: 'RETRO SPINS',
  ...
  { num: '15', super: 'Museum / 3D Interactive', title: 'GLOBAL\nMUSEUM HUB',
  ...
  { num: '16', super: 'UI/UX Design / Figma', title: 'FOOD\nDELIVERY APP',
  ...
  { num: '17', super: 'Framer / Interaction', title: 'FRAMER\nPROJECT',
